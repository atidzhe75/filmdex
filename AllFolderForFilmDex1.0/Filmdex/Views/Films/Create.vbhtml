...
@Using (Html.BeginForm()) 
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group" style="position: absolute; top: 250px; font-size: 25px">
        ...
        <div class="form-group" style="position: absolute; top: 330px; font-size: 25px">
        ...
        <div class="form-group"  style="position: absolute; top: 410px; font-size: 25px">
        ...
        <div class="form-group" style="position: absolute; top: 560px;">
            <div class="col-md-offset-2 col-md-10">
                <input type="submit" value="Create" class="btn btn-default" style="font-size: 25px"/> 
